...
- Radius vocabulary 0/0/2/4 — `full` reserved for StatusDot, Slider thumb (flagged for rounded-full audit chunk), ProgressBar tracks, MultiSelect chips (flagged); Switch track + thumb moved to `rounded-[2px]` (Decision #88); Stepper indicators likewise; Tabs pill moved to `rounded-[2px]` (Decision #86)
